...
gpu_instance_profiles = [CONST_GPU_INSTANCE_PROFILE_MIG1_G, CONST_GPU_INSTANCE_PROFILE_MIG2_G,
                         CONST_GPU_INSTANCE_PROFILE_MIG3_G, CONST_GPU_INSTANCE_PROFILE_MIG4_G, CONST_GPU_INSTANCE_PROFILE_MIG7_G]
...
def load_arguments(self, _):
    ...
    with self.argument_context('aks create') as c:
        ...
        c.argument('auto_upgrade_channel', arg_type=get_enum_type(
            [CONST_RAPID_UPGRADE_CHANNEL, CONST_STABLE_UPGRADE_CHANNEL, CONST_PATCH_UPGRADE_CHANNEL, CONST_NODE_IMAGE_UPGRADE_CHANNEL, CONST_NONE_UPGRADE_CHANNEL]))
    ...
    for scope in ['aks nodepool add']:
        with self.argument_context(scope) as c:
            ...
            c.argument('enable_cluster_autoscaler', options_list=[
                       "--enable-cluster-autoscaler", "-e"], action='store_true')
            c.argument('scale_down_mode', arg_type=get_enum_type(
                [CONST_SCALE_DOWN_MODE_DELETE, CONST_SCALE_DOWN_MODE_DEALLOCATE]))
            ...
            c.argument('mode', arg_type=get_enum_type(
                [CONST_NODEPOOL_MODE_SYSTEM, CONST_NODEPOOL_MODE_USER]))
            c.argument('aks_custom_headers')
            c.argument('ppg')
